                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style ="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="accessibility-outline" style="font-size: 1.6rem" class="text-primary mb-2"></ion-icon>
                            <br>
            ...
            <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style ="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="newspaper-outline" style="font-size: 1.6rem" class="text-success mb-2"></ion-icon>
                           <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style ="padding: 12px 12px !important; line-height:0.8rem">
                        ...
                        <ion-icon name="medkit-outline" style="font-size: 1.6rem" class="text-warning mb-2"></ion-icon>
                        <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style ="padding: 12px 12px !important; line-height:0.8rem">
                        ...
                        <ion-icon name="alarm-outline" style="font-size: 1.6rem" class="text-danger mb-2"></ion-icon>
                        <br>
