    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $karyawan->nama_lengkap }}" id="nama_lengkap" class="form-control" name="nama_lengkap" placeholder="Username">
              </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12">
            <select name="kode_cabang" id="kode_cabang" class="form-select">
                ...
                @foreach ($cabang as $cb)
                    <option {{ $karyawan->kode_cabang == $cb->kode_cabang ? 'selected' : '' }} value="{{ $cb->kode_cabang }}">{{ $cb->nama_cabang }}</option>
                @endforeach
            </select>
        </div>
    </div>
