                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $cb->lokasi_cabang }}</td>
                                            <td>{{ $cb->radius_cabang }}</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="#" class="edit btn btn-info btn-sm btn-edit" kode_cabang="{{ $cb->kode_cabang }}">
                                                ...
                                                <form action="/cabang/{{ $cb->kode_cabang }}/delete" style="margin-left:5px" method="POST">
                                                    @csrf
